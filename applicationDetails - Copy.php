	            ...
	            <div class="container">
	                <div class="panel panel-default">
                        ...
                        <div class="panel-body"> 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <button type="button" class="btn btn-success btn-md" id = "aprRejBtns"><i class="fa fa-fw fa-check" aria-hidden="true"></i>Approve</button>
                                    <button type="button" class="btn btn-danger btn-md" id = "aprRejBtns"><i class="fa fa-fw fa-trash" aria-hidden="true"></i>Reject</button>
                                </div>
                            </div>
                        </div>
					</div>
