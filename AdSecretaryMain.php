        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-fw fa-plus-square"></i> New Applicant</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-fw fa-check-square-o"></i> Approved List</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-fw fa-trash"></i> Rejected List</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div id="page-wrapper">
        	<div id = "templateMainRow">
	            <div class="container-fluid">
	                ...
	                <div class="row">
	                    <div class="col-lg-12">
	                        <h1 class="page-header">ADDITIONAL SECRETARY</h1>
	                    </div>
	                </div>
	                <!-- /.row -->
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" href="#collapse1"><i class="fa fa-fw fa-plus-square"></i> New Applications</a>
										</h4>
									</div>
										...
										<div class="panel-body">
											<table class="table table-hover"">
												...
												<tbody class = "table-hover">
													<?php $SAOb->newApplications($userLevel); ?>
												</tbody>
											</table>
										</div>
									</div>
									...
									<div id="collapse2" class="panel-collapse collapse">
										<div class="panel-body">
											<table class="table table-hover"">
												...
												<tbody class = "table-hover">
													<?php $SAOb->approvedApplications($userLevel); ?>
												</tbody>
											</table>
										</div>
									</div>
									...
									<div id="collapse3" class="panel-collapse collapse">
										<div class="panel-body">
											<table class="table table-hover"">
												...
												<tbody class = "table-hover">
													<?php $SAOb->rejectedApplications($userLevel); ?>
												</tbody>
											</table>
										</div>
									</div>
